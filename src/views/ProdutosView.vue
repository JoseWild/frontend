<template>
  <div class="container">
    ...
    <div class="row sub-container">
       <div class="col-sm-2">
           <ButtonView :callback="cadastrarProduto" value="Adicionar"></ButtonView>
       </div>
       <div class="col-sm-10 pesquisa">
           <input type="text" v-model="input" placeholder="Pesquisar produto..." />
       </div>
    </div>
            ...
            <tbody>
               <tr v-for="item in produtos" :key="item.id">
                ...
                <!--  <th>{{ item.prod_custo}}</th> -->
                  ...
                  <th>{{ item.prod_obs }}</th>
                  <th>
                     <span @click="alterarProduto(item)"><i class="fas fa-pen icones-tabela mr-2"></i></span>
                     <span @click="excluirProduto(item)"><i class="fas fa-trash-can icones-tabela mr-2"></i></span>
                  </th>
               </tr>
            </tbody>
          </table>
